...
MockAppNetworkService getAndRegisterAppNetworkService() {
  _removeRegistrationIfExists<AppNetworkService>();
  final service = MockAppNetworkService();
  locator.registerSingleton<AppNetworkService>(service);
  return service;
}
